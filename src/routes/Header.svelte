...
<div class="relative px-8 bg-black text-white">
	...
	>
		...
		<NavHamburger on:click={toggle} btnClass="text-white focus:outline-none whitespace-normal m-0.5 rounded-lg focus:ring-2 p-1.5 focus:ring-gray-400  bg-black hover:bg-black  ml-3 md:hidden" />
