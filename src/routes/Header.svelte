...
<div class="relative px-8 bg-black text-white">
	...
	>
		...
		<NavUl {hidden} activeClass="" nonActiveClass="" divClass="" class="" style="background:black" ulClass="bg-black dark:bg-black text-white dark:text-white rounded-lg border border-black dark:border-black flex flex-col p-4 mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
