	...
	<Footer footerType="socialmedia" style="background:transparent;">
		...
		<div class="md:flex md:justify-between">
		  ...
		  <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
			...
			<div>
			  ...
			  <FooterLinkGroup>
				<FooterLink liClass="mb-4" target="_blank" href="https://twitter.com/icx_one">Twitter</FooterLink>
		...
		<div class="sm:flex sm:items-center sm:justify-between">
		  ...
		  <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
			...
			<FooterIcon href="https://twitter.com/icx_one" target="_blank" class="text-gray-400 hover:text-gray-900">
