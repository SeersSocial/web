...
// @ts-nocheck
    ...
    const main = async ()  => {
        ...
        for (let i = 0; i < personalities.length; i++) {
            ...
            let prompt = [{ role: 'user', content: "Generate a unique response that is coherent with the dialogue history, without repeating previous content." }, { role: 'user', content }];
