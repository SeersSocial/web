        ...
        <Accordion activeClasses="" inactiveClasses="" defaultClass="">
            <AccordionItem>
                ...
                <div  class="space-y-4">
                    ...
                    <p>ICX is a Web3 decentralized, fully on-chain social network built atop the groundbreaking technology of the Internet Computer. Drawing inspiration from Twitter's intuitive design, ICX improves user interaction with exclusive crypto features like prediction markets. This platform allows you to voice your thoughts and use cryptocurrencies to predict future events. But this is merely the beginning. We envision ICX evolving into a vibrant platform akin to Elon Musk's 'X', with the potential to redefine global interactions and transactions.</p>
                    ...
                    <h3 class="text-sky-600">Features</h3>
                    <p>
                        ICX currently combines the main features of Twitter with the innovation of prediction markets. Looking ahead, we have ambitious plans to elevate our UI/UX and prediction markets to new heights, while also introducing a plethora of other exciting features and cutting-edge crypto primitives.
                        Some key features and planned developments of ICX include:
                    </p>
                    <ol>
                        ...
                        <li>- ckBTC staking, targeting an APY of up to 10%.</li>
                        <li>- Encrypted messages and posts using vetKeys.</li>
                        <li>- Communities with push button DAO, token creation and other features.</li>
                        <li>- Images drive with a view reminiscent of Instagram.</li>
                        <li>- We envision an internal NFT marketplace that is seamlessly connected with other marketplaces and the rest of the platform.</li>
                    ...
                    <p>Our team comprises a diverse and talented group of individuals with extensive experience in the web3 space, spanning across Europe and South America. Together, we bring a wealth of expertise in blockchain technology and decentralized applications. Our founder, ex Rust core developer for Polkadot and PhD, possesses deep insights into the inner workings of the blockchain ecosystem. Moreover, the team includes former Google employees who have contributed to large-scale projects, as well as individuals who have excelled in programming olympiads, showcasing their strong mathematical foundations. With their combined skills and knowledge, the ICX team is well-positioned to spearhead the revolution of social networking and prediction markets on a global scale.</p>
                </div>
            </AccordionItem>
            <AccordionItem>
                <span slot="header">ICX DAO</span>
                <div  class="space-y-4">
                    <h3 class="text-sky-600">Summary</h3>
                    <ul>
                        <li>- The ICX DAO will be established to govern and guide the direction of the ICX platform, serving as a decentralized autonomous organization owned by the community.</li>
                        <li>- Both the ICX DAO and the ICX services will be fully integrated on the blockchain, eliminating the need for reliance on off-chain services.</li>
                        <li>- ICX will operate using NNS-blessed SNS canisters and the SNS subnet, ensuring a secure and scalable infrastructure.</li>
                        <li>- A proposal will be submitted to the NNS (Internet Computer's Network Nervous System) to seek approval for the creation of the ICX DAO and its associated public good, solidifying its legitimacy and community-driven nature.</li>
                    </ul>
                </div>
            </AccordionItem>
            <AccordionItem>
                <span slot="header">ICX Token Utility</span>
                <div  class="space-y-4">
                    The ICX token offers an array of exciting use cases within the ICX ecosystem:
                    <ul>
                        <li><span class="text-sky-500">Governance and Voting:</span> ICX tokens can be staked as neurons, akin to ICP neurons, allowing token holders to actively participate in the governance of ICX by voting on proposals. By doing so, they earn voting rewards that increase over time, fostering long-term engagement and alignment with the platform's objectives.</li>
                        <li><span class="text-sky-500">Promotion of posts and markets:</span> Users can utilize ICX tokens to promote posts and prediction markets within the ICX ecosystem, increasing their visibility and reach among the community.</li>
                        <li><span  class="text-sky-500">Promotion of profiles:</span> ICX tokens can be used to secure featured placement on the ICX platform, highlighting specific profile, thus enhancing their exposure and attracting more followers.</li>
                        <li><span  class="text-sky-500">Content Moderation and Rewards:</span> Content moderators on ICX play a crucial role in maintaining the quality and integrity of the platform's content. To participate in content moderation, moderators are required to lock a specific amount of ICX tokens. This token commitment demonstrates their dedication to ensuring a safe and engaging environment for users. Through an automated reward mechanism, content moderators receive fair compensation based on their reputation scores. This incentivizes active participation, promotes the growth of a vibrant content ecosystem, and ensures the continuous improvement and quality of the content available on ICX.</li>
                        <li><span  class="text-sky-500">Access to Premium AI Services:</span>ICX tokens provide users with exclusive access to premium AI services within the ICX ecosystem. By leveraging their tokens, users can tap into the capabilities of state-of-the-art generative AI models, unlocking advanced functionalities for tasks such as content generation, creative design, and data synthesis. This integration of generative AI empowers users to explore new horizons of creativity, enabling them to generate unique and engaging content, collaborate with AI-powered tools, and unlock innovative possibilities within the ICX platform. The availability of these premium generative AI services adds an extra layer of value and creativity to the ICX experience, enhancing user engagement and pushing the boundaries of what's possible.</li>
                        <li><span  class="text-sky-500">Storage Payments:</span>ICX tokens can be used for payments related to storage services, such as on the ICX Drive, ensuring secure and efficient data storage within the platform.</li>
                        <li><span  class="text-sky-500">NFT Transactions on ICX Marketplace:</span> Within the ICX marketplace, users can buy and sell NFTs using ICX tokens. This facilitates seamless and secure transactions, fostering a vibrant marketplace for digital collectibles and unique assets.</li>
                    </ul>
                    These utility cases demonstrate the versatile and valuable nature of ICX tokens within the ICX ecosystem, encouraging active participation, rewarding contributions, and fueling the growth of the platform.
                </div>
            </AccordionItem>
            <AccordionItem>
                <span slot="header">Token allocation at SNS genesis</span>
                <div  class="space-y-4">
                    The SNS will be initialized with 100 million ICX tokens allocated in the following proportions.
                    ...
                    <p>To decentralize governance and raise funds for the ICX SNS, a total of 25% of the token supply will be made available for sale. The maximum amount that can be raised through this sale will be set at 1,000,000 ICP, while the minimum will be 500,000 ICP.</p>
                    ...
                    <p>During the sale, participants will deposit ICP into the SNS. Once the sale concludes, they will receive ICX tokens in proportion to their share of the deposited ICP. Each participant will receive their ICX tokens in the form of a basket containing 5 neurons of equal value. The first neuron will have no dissolve delay, allowing for immediate disbursement of liquid ICX tokens. The remaining neurons will have dissolve delays of 3, 6, 9, and 12 months, respectively.</p>
                    ...
                    <p>The ICX team has been diligently developing and running ICX since July 2022. Following the SNS sale of ICX tokens, the ICX Foundation will be established. The foundation will receive 15% (15,000,000) of the ICX tokens, distributed across 5 equal neurons. Each of these neurons will have a dissolve delay of 1 month, with "vesting periods" set at 0, 1, 2, 3, and 4 years, respectively.</p>

                    <p>Seed funders, on the other hand, will receive 8% of the ICX tokens as a basket of 5 equal neurons. Each neuron will have a dissolve delay of 1 month and "vesting periods" of 0, 6, 12, 18, and 24 months, respectively.</p>

                    <p>It is important to note that neurons with a "vesting period" cannot be accessed until the specified period has elapsed, including any potential extension of the dissolve delay. This mechanism ensures that founders and funders are prevented from rug-pulling investors and provides a continuous incentive to drive the success of ICX.</p>

                    <p>Since these founder/funder neurons have relatively short dissolve delays of 1 month that cannot be extended, it ensures reduced voting power compared to the community. This intentional design ensures proper decentralization of governance, empowering the community to have a significant say in shaping the future of ICX.</p>
                    ...
                    <p>Following the decentralization sale, the SNS will retain a treasury consisting of the remaining 52% of ICX tokens. This treasury will serve various purposes to support the growth and development of ICX.</p>

                    <p>The majority of the tokens will be utilized over time to automatically reward content moderators, fostering a thriving content ecosystem and facilitating the expansion of ICX. Additionally, the treasury will be available to fund community bounties through SNS proposals, compensating individuals who contribute to ICX in various ways. This includes rewarding third-party developers for their valuable code contributions.</p>

                    <p>A small portion, approximately 2%, will be allocated to provide initial liquidity pools for decentralized exchanges (DEXes). To enable the trading of ICX tokens, it is essential to list ICX on one or more exchanges. The intention is to list ICX on IC-based DEXes. Listing ICX on a DEX that implements an Automated Market Maker (AMM) requires the provision of a liquidity pool consisting of ICX tokens and another token, in this case, ICP raised from the decentralization sale. The plan is to make ICX available on multiple DEXes as they become available. Each DEX listing will require a proposal to transfer a specific amount of ICX from the SNS to the DEX, along with a corresponding proposal to transfer an equal value of ICP from the SNS to the DEX.</p>

                    <p>The SNS treasury plays a crucial role in supporting the ICX ecosystem, rewarding contributors, promoting liquidity, and facilitating the growth and accessibility of the ICX token on decentralized exchanges.</p>
                
                    <h3 class="text-sky-600">Valuation Range</h3>

                    <p>The inclusion of a maximum target is intended to provide participants with a guaranteed minimum allocation of ICX tokens in exchange for their ICP investment. With a lower bound of 500,000 ICP and an upper bound of 1,000,000 ICP for 25% of the tokens, the ICX DAO achieves an initial valuation range between 2M ICP and 4M ICP. Consequently, the initial value of 1 ICX token would range from 0.02 ICP to 0.04 ICP. This valuation range ensures transparency and establishes a framework for participants to assess the potential value of their investment in the ICX ecosystem.</p>
                </div>
            </AccordionItem>
            <AccordionItem>
            ...
            <AccordionItem>
                ...
                <div  class="space-y-4">
                        <p>The information presented in this white paper is subject to change or update, and should not be considered a commitment, promise, or guarantee by any individual or organization mentioned in the document regarding the future availability of services related to the use of tokens or their future performance or value. Approval from ICX SNS DAO members is required for the features or other aspects of the platform mentioned in the white paper</p>

                        <p>This document is for informational purposes only and does not constitute an offer or solicitation to sell any securities or shares. It should not be construed as an invitation to buy or subscribe for any securities, nor should it form the basis of any contract or commitment. ICX DAO assumes no responsibility for any loss or damage arising from reliance on the information contained in this document, including any errors or inaccuracies. Any actions taken based on the information in this document are taken at the reader's own risk.</p>
