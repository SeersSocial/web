...
<section class="w-full flex flex-col mt-14 text-lg justify-center justify-items-center content-center items-center">
	...
	<div class="flex flex-col md:w-2/3 gap-4">
		<h2 class="font-bold text-sky-500">Tokenomics Overview</h2>
		<p class="">The heart of ICX tokenomics revolves around a clear cap on the total supply, ensuring the total number of ICX tokens will never surpass 150 million. As of the current state, the supply stands at 100 million ICX tokens. The distribution of these tokens is delineated as follows:</p>
        ...
        <h2 class="font-bold text-sky-500">Advantages</h2>
        <ul class="list-inside space-y-4">
			<li><span class="underline decoration-emerald-400">Incentivized Engagement:</span> The tokenomics fosters network participation, with the initial inflation rate tailored to boost active engagement and community growth.</li>
			<li><span class="underline decoration-emerald-400">Balanced Economic Model:</span> The ICX model strives for consistent growth, avoiding drastic changes that might lead to market volatility.</li>
			<li><span class="underline decoration-emerald-400">Stakeholder Alignment:</span> By having a clear token allocation strategy, ICX ensures vested interest among developers, community members, and strategic planners in the project's success.</li>
            <li><span class="underline decoration-emerald-400">Future-Proofed Treasury:</span> The treasury's significant token allocation ensures a robust reserve for pivots, expansions, or unforeseen challenges, securing the network's future.</li>
        </ul>
        <p class="mb-4 font-medium">
            In conclusion, ICX's tokenomics is a meticulous fusion of strategic planning and community-driven priorities. It's designed to offer both immediate incentives for participation and the foundation for long-term network sustainability. Importantly, the ICX token serves as a utility within its ecosystem, and its distribution or use should not be viewed as a speculative instrument or a security.
        </p>
    </div>
</section>
